...
export function Suggestion() {
    ...
    useEffect(() => {
        fetch('https://api.github.com/users/GuiGavassa/followers')
            .then((response) => {
    ...
    return (
        <div className='container-suggestion'>
            <div className="header-suggestion">
                <img src="https://github.com/GuiGavassa.png" />
                <div className="user-infos-suggestion">
                    <div className="infos">
                        <span>guilherme.gavassa</span>
                        <p>Guilherme Gavassa</p>
                ...
                {slice.map((suggestion, key) => (
                    <div className='infos-suggestion' key={key}>
                        ...
                        <div className='info-suggestion'>
                            ...
                            <p>Seguido por joaovitor_conrado</p>
                        </div>
